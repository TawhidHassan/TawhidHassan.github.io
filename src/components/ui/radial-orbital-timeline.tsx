...
export default function RadialOrbitalTimeline({
  ...
  const getStatusStyles = (status: TimelineItem["status"]): string => {
    switch (status) {
      ...
      case "in-progress":
        return "text-accent bg-accent/15 border-accent/40";
      case "pending":
        return "text-muted bg-foreground/10 border-card-border";
      default:
        return "text-muted bg-foreground/10 border-card-border";
    }
  };
  ...
  return (
    <div
      className="w-full h-[320px] sm:h-[520px] md:h-[600px] flex flex-col items-center justify-center bg-background overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-accent-2 via-accent to-accent-3 animate-pulse flex items-center justify-center z-10">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${
                    isExpanded
                      ...
                      : "bg-card text-foreground backdrop-blur-md"
                  }
                  border-2
                  ${
                    isExpanded
                ...
                <div
                  ...
                  ${isExpanded ? "text-foreground scale-125" : "text-muted"}
                `}
                >
                  {item.title}
                </div>
